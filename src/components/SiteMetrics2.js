...
class SiteMetrics2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      metrics: {
  ...
  fetchMetrics = async () => {
    try {
      const response = await fetch('http://localhost:3000/api/metrics?siteid=lodo', {
        method: 'GET',
    ...
    return (
      <div style={styles.body}>
        <div style={styles.container}>
          <h1 style={styles.heading}>Site Metrics - LoDo</h1>
